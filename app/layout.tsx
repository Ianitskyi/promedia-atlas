...
import './atlas.css';
import './profiles.css';
export const metadata: Metadata = { title: 'Атлас Меда — ПроМедіа', description: 'Карта зареєстрованих медіа України. Пошук, регіони, реєстранти та правила реєстрації.', alternates:{languages:{uk:'https://atlas.promedia.report/',en:'https://atlas.promedia.report/en'}} };
