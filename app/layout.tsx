...
import './atlas.css';
import './profiles.css';
export const metadata: Metadata = { title: 'Атлас Медіа — ПроМедіа', description: 'Карта зареєстрованих медіа України. Пошук, регіони, особи або компанії, на які оформлено медіа, та правила реєстрації.', icons: { icon: '/favicon.png' }, alternates:{languages:{uk:'https://atlas.promedia.report/',en:'https://atlas.promedia.report/en'}} };
